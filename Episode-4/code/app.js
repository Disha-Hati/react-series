    ...
    return(
        <div className="header">
            <div className="logo-container">
                <img className="logo" src="https://i.imgur.com/nSItImb.png" alt="logo"/>
            </div>
...
const RestoCard=(props)=>{
    ...
    return (
        <div className="restocard">
            <img className="restocardlogo"src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" +restData.data.cloudinaryImageId}/>
    ...
    return(
        <div className="body">
            ...
            <div className="resto-container">
                {
                    resList.map(restaurant=> <RestoCard key={restaurant.data.id} restData= {restaurant}/> )
                }
